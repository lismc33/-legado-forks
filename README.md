...
| 版本号 | 日期 | 类型 | 更新内容 |
|--------|------|------|---------|
| 3.26.13-beta.26 | 2026-06-15 | Pre-release | 拆分ReadConfig为5个配置对象；修复阅读菜单透明度失效；修复屏幕超时失效和横屏半屏；字典弹窗Compose实现 |
| 3.26.13-beta.25 | 2026-06-14 | Pre-release | 顶栏液态玻璃胶囊布局；修复换源加载字数配置不生效；统一阅读界面二级菜单滑动动画 |
| 3.26.13-beta.24 | 2026-06-14 | Pre-release | 保存搜索范围选择；修复换源配置卡死 |
...
| 版本号 | 日期 | 类型 | 更新内容 |
|--------|------|------|---------|
| 3.26.052802 | 2026-05-27 | Pre-release | Bump json-path 2.10→3.0；Bump viewpager2 1.0→1.1；Bump material 1.13→1.14；Bump activity 1.11→1.13（依赖升级为主） |
